...
- ![image](https://github.com/user-attachments/assets/7621afe4-00d1-477e-843d-64a7d0f2bf87)
...
- 테스트 단계에서는 해당 테스트 데이터의 개수에 대한 평균과 표준편차를 이용해 정규화하지 않고, 학습 시에 구한 정규화 수식에 대입함.
